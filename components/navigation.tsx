        ...
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center">
            <Link href="/" className="flex items-center space-x-2 group">
              ...
              <span className="font-bold text-xl group-hover:text-primary transition-colors">LocalizeSDK</span>
            </Link>
          </div>
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-4">
              <Link
                href="/"
                className="text-foreground hover:text-primary px-3 py-2 rounded-md text-sm font-medium transition-all duration-200 hover:bg-primary/5"
              >
                Home
              </Link>
              <Link
                href="/pricing"
                className="text-muted-foreground hover:text-primary px-3 py-2 rounded-md text-sm font-medium transition-all duration-200 hover:bg-primary/5"
              >
                Pricing
              </Link>
              <Link
          ...
          <div className="hidden md:flex items-center space-x-4">
            <ModeToggle />
            <Link href="/login">
              <Button variant="ghost" size="sm" className="hover:text-secondary hover:bg-secondary/10">
                Sign In
              </Button>
            </Link>
            <Link href="/signup">
          ...
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-card/50 backdrop-blur-sm rounded-lg mt-2">
              ...
              <div className="flex space-x-2 px-3 py-2">
                <Link href="/login">
                  <Button variant="ghost" size="sm" className="w-full hover:text-secondary hover:bg-secondary/10">
                    Sign In
                  </Button>
                </Link>
                <Link href="/signup">
